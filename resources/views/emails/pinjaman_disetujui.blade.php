...
<body style="font-family: sans-serif; padding: 20px;">
    <div style="max-width: 500px; margin: auto; border: 1px solid #ddd; border-radius: 10px; padding: 20px;">
        ...
        <table style="width: 100%; margin-bottom: 20px;">
            <tr><td>Buku</td><td>: <strong>{{ $loan->book->title }}</strong></td></tr>
            <tr><td>Tgl Pinjam</td><td>: {{ $loan->borrowed_at }}</td></tr>
            <tr><td>Tgl Kembali</td><td>: <strong style="color: red;">{{ $loan->due_date }}</strong></td></tr>
        </table>
