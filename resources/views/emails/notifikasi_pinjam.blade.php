    ...
    <div style="max-width: 500px; margin: auto; background: white; border-radius: 15px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 30px;">
            <div style="text-align: center; margin-bottom: 20px;">
                ...
                <h1 style="margin: 5px 0; color: #11998e; letter-spacing: 5px;">#{{ $loan->id }}{{ date('Hi') }}</h1>
            </div>

            <table style="width: 100%; font-size: 14px; border-collapse: collapse;">
                <tr>
                    <td style="padding: 10px 0; color: #888;">Peminjam:</td>
                    <td style="padding: 10px 0; text-align: right; font-weight: bold;">{{ $loan->user->name }}</td>
                </tr>
                <tr>
                    <td style="padding: 10px 0; color: #888;">Judul Buku:</td>
                    <td style="padding: 10px 0; text-align: right; font-weight: bold;">{{ $loan->book->title }}</td>
                </tr>
                <tr>
                    <td style="padding: 10px 0; color: #888;">Tanggal Request:</td>
                    <td style="padding: 10px 0; text-align: right;">{{ date('d M Y') }}</td>
                </tr>
            </table>
