...
<div class="row g-4">
    <div class="col-12 col-md-4">
        <div class="stat-card">
            ...
            <h2 class="display-6 fw-800 mb-1" style="color: #1e293b;"><?php echo e($totalBooks ?? 0); ?></h2>
    ...
    <div class="col-12 col-md-4">
        <div class="stat-card">
            ...
            <h2 class="display-6 fw-800 mb-1" style="color: #1e293b;"><?php echo e($borrowToday ?? 0); ?></h2>
    ...
    <div class="col-12 col-md-4">
        <div class="stat-card">
            ...
            <h2 class="display-6 fw-800 mb-1" style="color: #1e293b;">Rp <?php echo e(number_format($totalFines ?? 0, 0, ',', '.')); ?></h2>
...
<script>
    fetch("<?php echo e(url('/admin/loan-stats')); ?>")
        .then(res => res.json())
        .then(data => {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AINANHAMMAL\perpustakaan-api\resources\views/admin.blade.php ENDPATH**/ ?>