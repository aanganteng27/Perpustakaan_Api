...
<?php $__env->startSection('title', 'Proses Pembayaran Denda'); ?>
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="summary-box mb-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <span class="fw-bold text-dark"><?php echo e($fine->loan->user->name); ?></span>
                        </div>
                    ...
                    <form action="<?php echo e(route('admin.fines.processPayment', $fine->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="d-flex gap-3 flex-wrap justify-content-center">
                                ...
                                <?php $__currentLoopData = $methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="method-option">
                                        <input type="radio" name="payment_method" value="<?php echo e($value); ?>" required>
                                        <div class="method-card">
                                            <span class="method-icon"><?php echo e($data['icon']); ?></span>
                                            <span class="method-label"><?php echo e($data['label']); ?></span>
                                        </div>
                                    </label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-center">
                            ...
                            <a href="<?php echo e(route('admin.fines.index')); ?>" class="btn btn-link text-muted text-decoration-none">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AINANHAMMAL\perpustakaan-api\resources\views/admin/fines/pay.blade.php ENDPATH**/ ?>