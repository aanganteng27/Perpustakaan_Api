        ...
        <div style="padding: 20px 0;">
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="text-align: right;">#FIN-<?php echo e($fine->id); ?></td>
                </tr>
                <tr>
                    <td style="color: #888;">Metode Bayar:</td>
                    <td style="text-align: right; text-transform: uppercase;"><?php echo e($fine->payment_method); ?></td>
                </tr>
                <tr>
                    <td style="color: #888;">Tanggal Bayar:</td>
                    <td style="text-align: right;"><?php echo e(\Carbon\Carbon::parse($fine->paid_at)->format('d M Y H:i')); ?></td>
                </tr>
                <tr>
                ...
                <tr style="font-size: 18px; font-weight: bold;">
                    <td>Total Bayar:</td>
                    <td style="text-align: right; color: #27ae60;">Rp <?php echo e(number_format($fine->amount, 0, ',', '.')); ?></td>
                </tr>
            </table>
        </div>
...
</html><?php /**PATH C:\Users\AINANHAMMAL\perpustakaan-api\resources\views/emails/pembayaran_denda_berhasil.blade.php ENDPATH**/ ?>