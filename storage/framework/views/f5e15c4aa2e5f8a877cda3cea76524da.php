...
<body>
    ...
    <div class="welcome-container">
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-center gap-3">
            <a href="<?php echo e(route('login')); ?>" class="btn-luxury">
    ...
    <footer>
        &copy; <?php echo e(date('Y')); ?> Quantum Library &bull; Designed for Excellence
    </footer>

    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
</body>
</html><?php /**PATH C:\Users\AINANHAMMAL\perpustakaan-api\resources\views/welcome.blade.php ENDPATH**/ ?>