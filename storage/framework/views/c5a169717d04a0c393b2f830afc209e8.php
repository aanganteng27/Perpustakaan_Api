    ...
    <div class="welcome-card">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-md-end mt-3 mt-md-0">
                <a href="<?php echo e(route('admin.books.create')); ?>" class="btn btn-white bg-white text-success px-4 py-2 shadow-sm fw-800 border-0 rounded-pill">
    ...
    <div class="table-container">
            ...
            <table class="table custom-table table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="fw-800 text-dark mb-0"><?php echo e($book->title); ?></div>
                            <div class="text-muted small"><i class="bi bi-person-fill me-1"></i><?php echo e($book->author); ?></div>
                        </td>
                        <td class="text-center">
                            <span class="badge bg-light text-dark border fw-normal"><?php echo e($book->isbn ?? '-'); ?></span>
                        </td>
                        <td>
                            <span class="small text-muted" title="<?php echo e($book->description); ?>">
                                <?php echo e(Str::limit($book->description, 45, '...')); ?>

                            </span>
                        </td>
                        <td class="text-center">
                            <span class="badge-category">
                                <?php echo e($book->category ?? 'Umum'); ?>

                            </span>
                        </td>
                        <td class="text-center">
                            <?php if($book->stock <= 5): ?>
                                <span class="badge bg-danger bg-opacity-10 text-danger px-3 rounded-pill fw-bold"><?php echo e($book->stock); ?></span>
                            <?php else: ?>
                                <span class="badge bg-success bg-opacity-10 text-success px-3 rounded-pill fw-bold"><?php echo e($book->stock); ?></span>
                            <?php endif; ?>
                        </td>
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-2">
                                <a href="<?php echo e(route('admin.books.edit', $book->id)); ?>" class="btn btn-sm btn-warning btn-action text-white shadow-sm" title="Edit">
        ...
        <div class="d-flex justify-content-between align-items-center mt-4 px-2">
            <div class="text-muted small fw-600">
                Menampilkan <?php echo e($books->firstItem()); ?> sampai <?php echo e($books->lastItem()); ?> dari <?php echo e($books->total()); ?> buku
            </div>
            <div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AINANHAMMAL\perpustakaan-api\resources\views/admin/books/index.blade.php ENDPATH**/ ?>