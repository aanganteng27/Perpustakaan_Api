...
<?php $__env->startSection('title', 'Edit Denda'); ?>
        ...
        <div class="col-lg-10">
            <div class="card fine-edit-card">
                <div class="card-body p-4 p-md-5">
                    <form method="POST" action="<?php echo e(route('admin.fines.update', $fine->id)); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control form-control-modern shadow-sm"
                                    value="<?php echo e($fine->loan->user->name); ?>" disabled>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="info-label">ID Transaksi</label>
                                <input type="text" class="form-control form-control-modern shadow-sm"
                                    value="#<?php echo e($fine->loan_id); ?>" disabled>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="info-label">Tanggal Pinjam</label>
                                <input type="text" class="form-control form-control-modern shadow-sm"
                                    value="<?php echo e($fine->loan->borrowed_at ? \Carbon\Carbon::parse($fine->loan->borrowed_at)->format('d F Y') : '-'); ?>" disabled>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="info-label">Tanggal Kembali</label>
                                <input type="text" class="form-control form-control-modern shadow-sm"
                                    value="<?php echo e($fine->loan->returned_at ? \Carbon\Carbon::parse($fine->loan->returned_at)->format('d F Y') : 'Belum Dikembalikan'); ?>" disabled>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="amount" id="amount"
                                        ...
                                        value="<?php echo e(old('amount', $fine->amount)); ?>" required>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="status" id="status" class="form-select form-control-modern form-select-modern shadow-sm" required>
                                    <option value="belum_dibayar" <?php echo e($fine->status == 'belum_dibayar' ? 'selected' : ''); ?>>
                                        🔴 Belum Dibayar
                                    </option>
                                    <option value="sudah_dibayar" <?php echo e($fine->status == 'sudah_dibayar' ? 'selected' : ''); ?>>
                                        🟢 Sudah Dibayar (Lunas)
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <input type="text" name="payment_method" id="payment_method" 
                                    ...
                                    value="<?php echo e(old('payment_method', $fine->payment_method)); ?>" 
                        ...
                        <div class="d-flex flex-wrap gap-3 mt-4 justify-content-end">
                            <a href="<?php echo e(route('admin.fines.index')); ?>" class="btn btn-cancel-custom px-4">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AINANHAMMAL\perpustakaan-api\resources\views/admin/fines/edit.blade.php ENDPATH**/ ?>