...
<head>
    ...
    <title>Kuitansi Pembayaran Denda #<?php echo e($fine->id); ?></title>
    <style>
...
<body onload="window.print()">
    ...
    <div class="receipt-card">
        ...
        <div class="item-row">
            ...
            <span class="item-value">#FIN-<?php echo e($fine->id); ?></span>
        </div>
        <div class="item-row">
            <span class="item-label">Tanggal Bayar</span>
            <span class="item-value"><?php echo e(\Carbon\Carbon::parse($fine->paid_at)->format('d M Y H:i')); ?></span>
        </div>
        <div class="item-row">
            <span class="item-label">Nama Peminjam</span>
            <span class="item-value"><?php echo e($fine->user->name ?? $fine->loan->user->name); ?></span>
        </div>
        ...
        <div class="item-row">
            ...
            <span class="item-value"><?php echo e($fine->loan->book->title); ?></span>
        </div>
        <div class="item-row">
            <span class="item-label">Metode Bayar</span>
            <span class="item-value"><?php echo e(strtoupper($fine->payment_method ?? 'Tunai')); ?></span>
        </div>

        <div class="total-box">
            <div class="total-label">TOTAL DENDA DIBAYAR</div>
            <div class="total-amount">Rp <?php echo e(number_format($fine->amount, 0, ',', '.')); ?></div>
        </div>
...
</html><?php /**PATH C:\Users\AINANHAMMAL\perpustakaan-api\resources\views/admin/fines/receipt.blade.php ENDPATH**/ ?>