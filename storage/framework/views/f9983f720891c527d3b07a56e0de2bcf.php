...
<div class="page-fade-in">
    ...
    <div class="header-card">
        ...
        <div class="search-container">
            <form method="GET" action="<?php echo e(route('admin.loans.index')); ?>" class="search-wrapper">
                <div class="input-group shadow-lg">
                    ...
                    <input type="text" name="search" class="form-control border-0 bg-transparent text-white" 
                           placeholder="Ketik nama peminjam di sini..." value="<?php echo e(request('search')); ?>">
                        ...
                        <tr class="table-row-luxury">
                            <td class="ps-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="fw-bold text-dark"><?php echo e($loan->user->name); ?></div>
                                        <small class="text-muted d-block"><?php echo e($loan->user->email); ?></small>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e($loan->book->cover_url); ?>" class="book-cover-mini me-3">
                                    <div>
                                        <div class="fw-semibold text-dark"><?php echo e($loan->book->title); ?></div>
                                        <small class="text-muted">Tersedia: <?php echo e($loan->book->stock); ?></small>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <span class="text-dark fw-medium">
                                    ...
                                    <?php echo e($loan->borrowed_at ? date('d M Y', strtotime($loan->borrowed_at)) : '---'); ?>
                            ...
                            <td>
                                <span class="text-dark fw-medium">
                                    ...
                                    <?php echo e($loan->due_date ? date('d M Y', strtotime($loan->due_date)) : '---'); ?>
                                ...
                                <div class="btn-group shadow-sm rounded-3">
                                    ...
                                    <?php elseif($loan->status === 'dipinjam'): ?>
                                        <button class="btn btn-warning btn-sm px-3 border-0 text-white rounded-start-3" 
                                                ...
                                                data-id="<?php echo e($loan->id); ?>" data-date="<?php echo e($loan->due_date); ?>">
                                            <i class="bi bi-pencil-square"></i>
                                        </button>
                                        <form action="<?php echo e(route('admin.loans.markReturned', $loan->id)); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                            <button class="btn btn-success btn-sm px-3 border-0">
                                                <i class="bi bi-arrow-counterclockwise"></i>
                                            </button>
                                        </form>
                                        <form action="<?php echo e(route('admin.loans.markLost', $loan->id)); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AINANHAMMAL\perpustakaan-api\resources\views/admin/loans/index.blade.php ENDPATH**/ ?>