    ...
    <div style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); padding: 3rem 2.5rem 6rem 2.5rem; position: relative;">
        <div class="d-flex justify-content-between align-items-center position-relative">
            ...
            <div class="stats-badge-modern">
                ...
                <span style="font-size: 2.2rem; font-weight: 800; color: #ffffff; line-height: 1;"><?php echo e($users->count()); ?></span>
            </div>
        </div>
    </div>
                        ...
                        <tr>
                            <td class="text-center align-middle">
                                <?php if($user->profile_photo): ?>
                                    <img src="<?php echo e(asset('storage/' . $user->profile_photo)); ?>" class="user-avatar" alt="User">
                                <?php else: ?>
                                    <div class="user-avatar-placeholder">
                                        <span class="fw-bold"><?php echo e(strtoupper(substr($user->name, 0, 1))); ?></span>
                                    </div>
                                <?php endif; ?>
                            </td>
                            <td class="align-middle">
                                <div class="fw-bold text-dark"><?php echo e($user->name); ?></div>
                                <span class="badge <?php echo e((isset($user->role) && $user->role == 'ADMIN') ? 'bg-warning' : 'bg-light text-dark'); ?> border" style="font-size: 0.7rem;">
                            ...
                            <td class="align-middle">
                                <div class="text-muted small">
                                    <i class="far fa-envelope me-1 text-primary"></i> <?php echo e($user->email); ?>
                            ...
                            <td class="text-center align-middle">
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    <form action="<?php echo e(route('admin.users.destroy', $user->id)); ?>" method="POST" onsubmit="return confirm('Hapus personil ini?')">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AINANHAMMAL\perpustakaan-api\resources\views/admin/users/index.blade.php ENDPATH**/ ?>